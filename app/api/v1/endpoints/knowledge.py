...
async def update_document_permission(
    ...
    # 2. 校验参数
    if permission_update.visibility == Visibility.GROUP and not permission_update.authorized_group_ids:
    ...
    try:
        rag_service.update_doc_permission(
            document_id, 
            permission_update.visibility.value,
    ...
    return {
        ...
        "id": document_id,
        "visibility": permission_update.visibility.value,
